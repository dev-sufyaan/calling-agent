...
case "$PY_MAJ_MIN" in
    3.12|3.13|3.14) ;;
    *)
        echo "Error: Python 3.12, 3.13, or 3.14 required, found $PY_MAJ_MIN at $(command -v "$PYTHON_BIN")." >&2
        echo "Activate a venv built with python3.12, python3.13, or 3.14 and retry." >&2
        exit 1
        ;;
esac
